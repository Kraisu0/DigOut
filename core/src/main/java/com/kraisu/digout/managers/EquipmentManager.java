...
public class EquipmentManager {
    ...
    private void initializeEquipment() {
        ...
        equipmentStuff.put(Constants.Equipment.KITCHEN_ROBOT, new Equipment("Kitchen Robot", "This robot can work for two in the kitchen with the Cook", "assets/equipment/KR_icon_64.png", 0 ));
        equipmentStuff.put(Constants.Equipment.OXYGEN_MASK, new Equipment("Oxygen mask", "Thanks to this item, the Survivor does not experience oxygen loss", "assets/equipment/OM_icon_64.png", 0 ));
